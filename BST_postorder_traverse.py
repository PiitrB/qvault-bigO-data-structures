...
# Assignment
# Implement the recursive postorder method. It returns a list of the values in the order they are visited, 
...
# Visit the value of the current node by appending it's value to the visited array
